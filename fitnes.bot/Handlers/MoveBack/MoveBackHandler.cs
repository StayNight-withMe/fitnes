...
public class MoveBackHandler : IBotHandler
{
    ...
    public MoveBackHandler(IMediator mediator, ITelegramBotClient botClient, IRequestContext context, ISessionRepository sessionRepository, IOptionsMonitor<SessionOptions> sessionOptions)
    {
        _mediator = mediator;
    ...
    {
        return update.CallbackQuery?.Data is string data && data.StartsWith(Domain.Constants.Bot.CallbackPrefixConstants.Back);
    }
